...
<body>
            ...
            <ul class="list-unstyled topbar-nav float-right mb-0">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ti-user text-muted mr-2"></i> Profile</a>
                        <div class="dropdown-divider mb-0"></div><a class="dropdown-item" href="logout.php"><i class="ti-power-off text-muted mr-2"></i> Logout</a>
                    </div>
                </li>
            </ul>
            <!--end topbar-nav-->
    ...
    <div class="left-sidenav">
        <ul class="metismenu left-sidenav-menu">
            ...
            <li <?php if ($_GET[module] == "mahasiswa") {
                    echo 'class="mm-active"';
                } ?>>
                <a href="media.php?module=mahasiswa"><i class="ti-user"></i><span>mahasiswa</span></a>
