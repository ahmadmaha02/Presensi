              ...
              <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td><a href="" onclick="gambar('web_service/foto/<?php echo $q[Foto] ?>')" data-toggle="modal" data-target="#ambilgambar">
                        <center><img src="web_service/foto/<?php echo $q[Foto] ?>" width='90px'></center>
                      </a></td>
