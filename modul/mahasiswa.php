...
if (isset($_POST['submit'])) {
  ...
  $cekusername = mysql_num_rows(mysql_query("SELECT * from mahasiswa where username='$_POST[username]'"));

  if ($cekusername < 1) {
    $password = md5($_POST[password]);
    mysql_query("INSERT INTO mahasiswa ( `username`, `password`, `nama`, `id_level`,`alamat`,`phone`,`TanggalBuat`,`Ktp`) values ('$_POST[username]','$password','$_POST[nama]','$_POST[level]','$_POST[alamat]','$_POST[phone]',NOW(),'$_POST[ktp]')");
  ...
  header('location:media.php?module=mahasiswa');
  ...
  mysql_query("UPDATE `mahasiswa` SET `nama`='$_POST[nama]',`phone`='$_POST[phone]',`alamat`='$_POST[alamat]',`Ktp`='$_POST[ktp]' WHERE username='$_POST[username]'");
  echo '<script type="text/javascript">
           window.location = "media.php?module=mahasiswa"
      </script>';
}
      ...
      <div class="col-md-12">
        <div class="card-box card shadow">
          ...
          <div class="card-body">
            ...
            <h2 class="mb-0">Master mahasiswa</h2>
            <hr />
            ...
            <div class="table-responsive">
              <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                  ...
                  <?php
                  $query = mysql_query("select a.*,b.Level as NamaLevel,b.id as idlevel from mahasiswa a
                  ...
                  while ($q = mysql_fetch_array($query)) {
                    ...
                    echo "
                              ...
                              <td>$no</td>
                                ...
                                <td>
                                <a href=\"media.php?module=mahasiswa&act=edit&id=$q[id]\" ><span class=\"badge badge-warning\">Edit</span></a>
                                <a href=\"media.php?module=mahasiswa&delete=y&id=$q[id]\" ><span class=\"badge badge-danger\">Hapus</span></a>
                                 </td>
                              </tr>";
                  }
